...
class MockWorksheet():
    ...
    def col_values(self, value):
        cols = [["empty col"], ["John"], ["john@gmail.com"],
                ["10"], ["4"], ["6"]]
        return cols[value]
    ...
    def get_all_values(self):
        return [["Name", "Email", "Games", "Wins", "Loses"],
                ["John", "john@gmail.com", "10", "4", "6"],
                ["Pat", "pat@gmail.com", "12", "8", "4"]]
...
class TestLeaderboardDisplay(unittest.TestCase):
    ...
    def test_top_bottom_of_leaderboard(self):
        self.assertEqual(
            leaderboard.top_bottom_of_leaderboard(),
            f"{' ' * 16 + Fore.YELLOW + '=' * 87}\n")

    def test_empty_leaderboard_line(self):
        self.assertEqual(
            leaderboard.empty_leaderboard_line(),
            f"{' ' * 16 + Fore.YELLOW + '|' + Fore.YELLOW + '|' + ' ' * 15}" +
            f"{Fore.YELLOW + '|' + ' ' * 15 + Fore.YELLOW + '|' + ' ' * 17}" +
            f"{Fore.YELLOW + '|' + ' ' * 15 + Fore.YELLOW + '|' + ' ' * 17}" +
            f"{Fore.YELLOW + '|' + Fore.YELLOW + '|'}\n")

    def test_leaderboard_headings(self):
        self.assertEqual(
            leaderboard.leaderboard_headings(),
            f"{' ' * 16 + Fore.YELLOW + '|' + Fore.YELLOW + '|' + ' ' * 4}" +
            f"{Fore.CYAN + 'R A N K' + ' ' * 4 + Fore.YELLOW + '|'}" +
            f"{' ' * 4 + Fore.CYAN + 'N A M E' + ' ' * 4}" +
            f"{Fore.YELLOW + '|' + ' ' * 4 + Fore.CYAN + 'G A M E S'}" +
            f"{' ' * 4 + Fore.YELLOW + '|' + ' ' * 4}" +
            f"{Fore.CYAN + 'W I N S' + ' ' * 4 + Fore.YELLOW + '|'}" +
            f"{' ' * 4 + Fore.CYAN + 'L O S E S' + ' ' * 4}" +
            f"{Fore.YELLOW + '|' + Fore.YELLOW + '|'}\n")

    def test_display_leaderboard_heading(self):
        self.assertEqual(
            leaderboard.display_leaderboard_heading(),
            f"{leaderboard.top_bottom_of_leaderboard()}" +
            f"{leaderboard.empty_leaderboard_line()}" +
            f"{leaderboard.leaderboard_headings()}" +
            f"{leaderboard.empty_leaderboard_line()}" +
            f"{leaderboard.top_bottom_of_leaderboard()}")
    ...
    def test_sort_leaderboard_data(self):
        self.assertEqual(
            leaderboard.sort_leaderboard_data(
                leaderboard.get_leaderboard_data(), 2),
            [["Pat", "pat@gmail.com", "12", "8", "4"],
             ["John", "john@gmail.com", "10", "4", "6"]])
        self.assertEqual(
            leaderboard.sort_leaderboard_data(
                leaderboard.get_leaderboard_data(), 3),
            [["Pat", "pat@gmail.com", "12", "8", "4"],
             ["John", "john@gmail.com", "10", "4", "6"]])
        self.assertEqual(
            leaderboard.sort_leaderboard_data(
                leaderboard.get_leaderboard_data(), 4),
            [["Pat", "pat@gmail.com", "12", "8", "4"],
             ["John", "john@gmail.com", "10", "4", "6"]])

    def test_format_leaderboard_rank_wins_name(self):
        self.assertEqual(
            leaderboard.format_leaderboard_rank_wins_name("1", "rank"),
            f"{Fore.WHITE + ' ' * 7 + '1' + ' ' * 7}")
        self.assertEqual(
            leaderboard.format_leaderboard_rank_wins_name(
                "12", "rank"),
            f"{Fore.WHITE + ' ' * 6 + '1' + ' ' + '2' + ' ' * 6}")
        self.assertEqual(
            leaderboard.format_leaderboard_rank_wins_name(
                "123", "rank"),
            f"{Fore.WHITE + ' ' * 5 + '1' + ' ' + '2' + ' ' + '3' + ' ' * 5}")
        self.assertEqual(
            leaderboard.format_leaderboard_rank_wins_name(
                "1234", "rank"),
            f"{Fore.WHITE + ' ' * 4 + '1' + ' ' + '2' + ' ' + '3'}" +
            f"{' ' + '4' + ' ' * 4}")
        self.assertEqual(
            leaderboard.format_leaderboard_rank_wins_name(
                "12345", "rank"),
            f"{Fore.WHITE + ' ' * 3 + '9 9 9 9 +' + ' ' * 3}")
        self.assertEqual(
            leaderboard.format_leaderboard_rank_wins_name(
                "12345", "name"),
            f"{Fore.WHITE + ' ' * 3 + '1' + ' ' + '2' + ' ' + '3'}" +
            f"{' ' + '4' + ' ' + '5' + ' ' * 3}")
        self.assertEqual(
            leaderboard.format_leaderboard_rank_wins_name(
                "123456", "name"),
            f"{Fore.WHITE + ' ' * 2 + '1' + ' ' + '2' + ' ' + '3'}" +
            f"{' ' + '4' + ' ' + '5' + ' ' + '6' + ' ' * 2}")
        self.assertEqual(
            leaderboard.format_leaderboard_rank_wins_name(
                "1234567", "name"),
            f"{Fore.WHITE + ' ' * 3 + '12345' + '... ' + ' ' * 3}")

    def test_format_leaderboard_games_and_loses(self):
        self.assertEqual(
            leaderboard.format_leaderboard_games_and_loses(
                "1"),
            f"{Fore.WHITE + ' ' * 8 + '1' + ' ' * 8}")
        self.assertEqual(
            leaderboard.format_leaderboard_games_and_loses(
                "12"),
            f"{Fore.WHITE + ' ' * 7 + '1' + ' ' + '2' + ' ' * 7}")
        self.assertEqual(
            leaderboard.format_leaderboard_games_and_loses(
                "123"),
            f"{Fore.WHITE + ' ' * 6 + '1' + ' ' + '2' + ' ' + '3' + ' ' * 6}")
        self.assertEqual(
            leaderboard.format_leaderboard_games_and_loses(
                "1234"),
            f"{Fore.WHITE + ' ' * 5 + '1' + ' ' + '2' + ' ' + '3'}" +
            f"{' ' + '4' + ' ' * 5}")
        self.assertEqual(
            leaderboard.format_leaderboard_games_and_loses(
                "12345"),
            f"{Fore.WHITE + ' ' * 4 + '1 0 0 0 +' + ' ' * 4}")

    def test_leaderboard_data_line(self):
        self.assertEqual(
            leaderboard.leaderboard_data_line(
                ["Jon", "john@gmail.com", "10", "4", "6"], "2"),
            f"{' ' * 16 + Fore.YELLOW + '|' + Fore.YELLOW + '|'}" +
            f"{leaderboard.format_leaderboard_rank_wins_name('2', 'rank')}" +
            f"{Fore.YELLOW + '|'}" +
            f"{leaderboard.format_leaderboard_rank_wins_name('Jon', 'name')}" +
            f"{Fore.YELLOW + '|'}" +
            f"{leaderboard.format_leaderboard_games_and_loses('10')}" +
            f"{Fore.YELLOW + '|'}" +
            f"{leaderboard.format_leaderboard_rank_wins_name('4', 'wins')}" +
            f"{Fore.YELLOW + '|'}" +
            f"{leaderboard.format_leaderboard_games_and_loses('6')}" +
            f"{Fore.YELLOW + '|' + Fore.YELLOW + '|'}\n")

    @patch("leaderboard.WORKSHEET", mock_worksheet)
    def test_display_leaderboard_ranks(self):
        self.assertEqual(
            leaderboard.display_leaderboard_ranks(2),
            [[1, "Pat", "pat@gmail.com", "12", "8", "4"],
             [2, "John", "john@gmail.com", "10", "4", "6"]])
        self.assertEqual(
            leaderboard.display_leaderboard_ranks(3),
            [[1, "Pat", "pat@gmail.com", "12", "8", "4"],
             [2, "John", "john@gmail.com", "10", "4", "6"]])
        self.assertEqual(
            leaderboard.display_leaderboard_ranks(4),
            [[1, "Pat", "pat@gmail.com", "12", "8", "4"],
             [2, "John", "john@gmail.com", "10", "4", "6"]])
    ...
    def test_go_to_leaderboard_return(self, mock_input):
        self.assertEqual(
            leaderboard.go_to_leaderboard(), "return_to_main_menu")
